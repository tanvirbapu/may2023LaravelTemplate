                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" method="post" action="{{ route('crud.store') }}"
                                    enctype="multipart/form-data" novalidate>
                                    @csrf
                                    <div class="col-md-6 position-relative">
                                        <label for="validationTooltip01" class="form-label">Text Box</label>
                                        <input type="text" name="textbox" class="form-control" id="validationTooltip01"
                                            required>
                                    ...
                                    <div class="col-md-6 position-relative">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="radiobutton"
                                                id="gridRadios1" value="First Radio" checked>
